...
dialogue_draw_rec :: proc() {
    ...
    rl.DrawRectangleLines(i32(textBox.x), i32(textBox.y), i32(textBox.width), i32(textBox.height), dialogue_text_color)
}

dialogue_draw :: proc(thing_to_say: cstring) {
    dialogue_draw_rec()
    rl.DrawTextEx(default_font, thing_to_say, { textBox.x + 4, textBox.y + 4 }, default_font_size, 1, dialogue_text_color)
}
